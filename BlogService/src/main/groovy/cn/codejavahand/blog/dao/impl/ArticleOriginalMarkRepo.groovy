...
class ArticleOriginalMarkRepo implements IArticleOriginalMarkRepo {
    ...
    void createUpdate(String id, String mark) {
        TextFileOpUtils.write sysConfig.rootPath + "/$id/${ComConst.ORIGINAl_FILE_NAME}", mark, false, true
    }

    @Override
    @Cacheable(value = "originalMark", key = "#id")
    String getById(String id) {
        TextFileOpUtils.readAllString sysConfig.rootPath + "/$id/${ComConst.ORIGINAl_FILE_NAME}"
    }
}
